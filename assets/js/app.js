...
function matchesFilter(c, routing){
  ...
  if(activeFilter==='training') return c.training.status!=='Completed';
...
function showDetail(id){
  ...
  let html = `
    ...
    <div class="panel-grid">
      <div class="panel">
        ...
        <div class="field-row"><span class="field-label">Portfolio</span><span class="field-value">${c.units} units</span></div>
      </div>
      <div class="panel">
        <h3>Accounting</h3>
        <div class="field-row"><span class="field-label">Live with Accounting</span><span class="field-value">${c.agentLiveWithAccounting ? 'Yes' : 'No'}</span></div>
        <div class="field-row"><span class="field-label">Go-Live Date</span><span class="field-value">${fmtDate(c.goLiveDate)}</span></div>
  ...
  if(c.reconciliation){
    html += `
      <div class="panel">
        ...
        <div class="field-row"><span class="field-label">Specialist</span><span class="field-value">${c.reconciliation.specialist}</span></div>
  ...
  if(c.onboardingProject){
    html += `
      <div class="panel">
        <h3>Current Accounting Project</h3>
        <div class="field-row"><span class="field-label">Target Go-Live</span><span class="field-value">${fmtDate(c.onboardingProject.targetGoLive)}</span></div>
        <div class="field-row"><span class="field-label">Opening Balance Booked</span><span class="field-value">${c.onboardingProject.openingBalanceBooked ? 'Yes' : 'No'}</span></div>
        <div class="field-row"><span class="field-label">Client Accounting Enabled</span><span class="field-value">${c.onboardingProject.clientAccountingEnabled ? 'Yes' : 'No'}</span></div>
      </div>`;
  }
  if(c.optOut){
    html += `
  ...
  html += `
      <div class="panel">
        <h3>Training</h3>
        <div class="field-row"><span class="field-label">Status</span><span class="field-value">${c.training.status}</span></div>
        <div class="field-row"><span class="field-label">Last Training Date</span><span class="field-value">${fmtDate(c.training.lastDate)}</span></div>
        <div class="field-row"><span class="field-label">Trainer</span><span class="field-value">${c.training.trainer}</span></div>
  ...
  const noteEntries = [
    ...
    ['Client Accounting Reconciliation Notes', c.reconciliation ? c.reconciliation.notes : ''],
