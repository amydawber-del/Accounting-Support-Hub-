...
function renderDiagnostics(){
  ...
  el.innerHTML = `${d.companiesWrittenToSupportHub} of ${d.companiesFetchedFromRocketlane} companies synced` +
  ...
  el.onclick = () => {
    alert(
      ...
      `Companies with no Accounting project found at all: ${missing}\n\n` +
      'Full breakdown (including sample skipped company names) is in the ' +
      'GitHub Action run logs under Actions → Sync Rocketlane data.'
    );
  };
}
